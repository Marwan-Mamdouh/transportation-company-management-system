...
public enum ErrorMessage {
  EMPLOYEE_NOT_FOUND("Employee not found."), DUPLICATE_EMPLOYEE_ID(
      "Duplicate employee Id."), NOT_VALID_CREDENTIALS(
      "Credentials are not valid."), DUPLICATE_EMPLOYEE_DATA(
      "Duplicate Employee data, check SSN, email or phone number."), PASSWORD_NOT_VALID(
      ...
      "No Available Seats founded."), SEAT_ALREADY_BOOKED(
