...
@Service
public class UpdateEmployeeLastNameService implements Command<UpdateEmployeePart, EmployeeDTO> {

  private final EmployeeRepository employeeRepository;

  public UpdateEmployeeLastNameService(EmployeeRepository employeeRepository) {
  ...
  public ResponseEntity<EmployeeDTO> execute(UpdateEmployeePart input) {
    ...
    employee.setLastName(input.employeeProperty());
