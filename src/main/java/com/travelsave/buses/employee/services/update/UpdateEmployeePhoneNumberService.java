...
@Service
public class UpdateEmployeePhoneNumberService implements Command<UpdateEmployeePart, EmployeeDTO> {

  private final EmployeeRepository employeeRepository;

  public UpdateEmployeePhoneNumberService(EmployeeRepository employeeRepository) {
  ...
  public ResponseEntity<EmployeeDTO> execute(UpdateEmployeePart input) {
    ...
    employee.setPhoneNumber(input.employeeProperty());
